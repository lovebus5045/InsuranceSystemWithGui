...
import control.cOnTheSeaInsuranceRegistration;
import global.constant.eBoatType;
import global.constant.eGender;
import global.constant.eJob;
import global.constant.eLongTerm;
import global.constant.eOnTheSeaType;

public class onTheSeaInsuranceRegistrationView extends JFrame {
	...
	private cOnTheSeaInsuranceRegistration cOnTheSeaInsuranceRegistration;

	public onTheSeaInsuranceRegistrationView() {
	...
	public void run() {
		if (painted == true) {
			...
			for (eOnTheSeaType eProperty : eOnTheSeaType.values()) {
			...
			for (eBoatType eProperty : eBoatType.values()) {
				JRadioButton button = new JRadioButton(eProperty.getText());
				button.setActionCommand(eProperty.getText());
				button.addActionListener(actionHandler);
				this.buttons.add(button);
	...
	public void putText() {
		cOnTheSeaInsuranceRegistration.setName(inputText[0].getText());
		cOnTheSeaInsuranceRegistration.setResidentRegistrationNumber(inputText[1].getText());
		cOnTheSeaInsuranceRegistration.setAge(Integer.parseInt(inputText[2].getText()));
		cOnTheSeaInsuranceRegistration.setPhoneNumber(inputText[3].getText());
		cOnTheSeaInsuranceRegistration.setAddress(inputText[4].getText());
		cOnTheSeaInsuranceRegistration.setAccountNumber(inputText[5].getText());
		cOnTheSeaInsuranceRegistration.setNote(inputText[6].getText());
		
		cOnTheSeaInsuranceRegistration.setGender(group1.getSelection().getActionCommand());
		cOnTheSeaInsuranceRegistration.setJob(group2.getSelection().getActionCommand());
		cOnTheSeaInsuranceRegistration.setLongterm(group3.getSelection().getActionCommand());
		cOnTheSeaInsuranceRegistration.setBoatType(group4.getSelection().getActionCommand());
		cOnTheSeaInsuranceRegistration.setOnTheSeaType(group5.getSelection().getActionCommand());
		
		cOnTheSeaInsuranceRegistration.run();
	}
