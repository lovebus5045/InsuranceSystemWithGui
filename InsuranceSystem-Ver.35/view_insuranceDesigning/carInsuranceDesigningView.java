...
public class carInsuranceDesigningView extends JFrame {
	...
	private void putText() {
		cCarInsuranceDesinging.setSubscriptionTarget(this.inputText[0].getText());
		cCarInsuranceDesinging.setPayment(this.inputText[1].getText());
		cCarInsuranceDesinging.setPeriod(this.inputText[2].getText());
		cCarInsuranceDesinging.setPaymentMethod(this.inputText[3].getText());
		cCarInsuranceDesinging.setInsurnaceMoney(this.inputText[4].getText());
		cCarInsuranceDesinging.setCompensationAmount(this.inputText[5].getText());
		cCarInsuranceDesinging.setNotes(this.inputText[6].getText());
		cCarInsuranceDesinging.setSpecialSubscription(this.inputText[7].getText());
		cCarInsuranceDesinging.setLongterPeriod(this.inputText[8].getText());

		cCarInsuranceDesinging.runcarInsurnaceDesign();
	}
