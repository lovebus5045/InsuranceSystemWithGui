...
public class fireInsuranceDesigningView extends JFrame {
	...
	private void putText() {
		...
		cFireInsuranceDesigning.setCompensationAmount(this.inputText[5].getText());
		...
		cFireInsuranceDesigning.setLongtermPeriod(this.inputText[8].getText());
