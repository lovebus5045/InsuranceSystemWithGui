...
import control.cOnTheSeaInsuranceDesinging;

public class onTheSeaInsuranceDesigningView extends JFrame {
	...
	private cOnTheSeaInsuranceDesinging cOnTheSeaInsuranceDesinging;
	private boolean stopper;

	public onTheSeaInsuranceDesigningView() {
		this.actionHandler = new actionHandler();
		this.cOnTheSeaInsuranceDesinging = new cOnTheSeaInsuranceDesinging();
	...
	private void putText() {
		cOnTheSeaInsuranceDesinging.setSubscriptionTarget(this.inputText[0].getText());
		cOnTheSeaInsuranceDesinging.setPayment(this.inputText[1].getText());
		cOnTheSeaInsuranceDesinging.setPeriod(this.inputText[2].getText());
		cOnTheSeaInsuranceDesinging.setPaymentMethod(this.inputText[3].getText());
		cOnTheSeaInsuranceDesinging.setInsurnaceMoney(this.inputText[4].getText());
		cOnTheSeaInsuranceDesinging.setCompensationAmount(this.inputText[5].getText());
		cOnTheSeaInsuranceDesinging.setNotes(this.inputText[6].getText());
		cOnTheSeaInsuranceDesinging.setSpecialSubscription(this.inputText[7].getText());
		cOnTheSeaInsuranceDesinging.setLongterPeriod(this.inputText[8].getText());

		cOnTheSeaInsuranceDesinging.runOnTheSeaInsurnaceDesign();
	}
